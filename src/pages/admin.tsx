...
const TIMELINE_JOBS: TimelineJob[] = [
  { id: 'tj1', providerId: 'p1', providerName: 'Marcus Thompson', service: 'Lawn Care', address: '112 Maple Ave', startHour: 8, durationHours: 1, status: 'complete', payout: 36, payoutStatus: 'pending_approval', beforePhoto: true, afterPhoto: true, customerRating: 5, ratingFlag: 'none', ratingNote: '', fixItWindowOpen: false, addOns: 35 },
  { id: 'tj2', providerId: 'p1', providerName: 'Marcus Thompson', service: 'Lawn Care', address: '247 Oak St', startHour: 9, durationHours: 1, status: 'in_progress', payout: 36, payoutStatus: 'pending_approval', beforePhoto: true, afterPhoto: false, customerRating: null, ratingFlag: 'none', ratingNote: '', fixItWindowOpen: true, addOns: 0 },
  { id: 'tj3', providerId: 'p1', providerName: 'Marcus Thompson', service: 'Lawn Care', address: '389 Elm Dr', startHour: 10, durationHours: 1, status: 'pending', payout: 36, payoutStatus: 'pending_approval', beforePhoto: false, afterPhoto: false, customerRating: null, ratingFlag: 'none', ratingNote: '', fixItWindowOpen: true, addOns: 0 },
  ...
  { id: 'tj8', providerId: 'p3', providerName: 'Jordan Lee', service: 'Lawn Care', address: '99 Walnut Way', startHour: 11, durationHours: 1, status: 'disputed', payout: 36, payoutStatus: 'rejected', beforePhoto: false, afterPhoto: false, customerRating: 1, ratingFlag: 'suspicious', ratingNote: 'No photo proof submitted. Customer reports work not done.', fixItWindowOpen: false, addOns: 0 },
];
