...
export default defineConfig(({ mode, isSsrBuild }) => ({
  ...
  server: {
    ...
    // Also warms up React CJS deps so needsInterop is resolved at startup,
    // not on the first browser request (which would invalidate in-flight URLs).
    warmup: {
